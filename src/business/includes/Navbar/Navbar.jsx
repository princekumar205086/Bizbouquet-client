    ...
    <>
      <nav className="navbar navbar-expand-lg bg-blue shadow-lg">
        <div className="container-fluid">
          <Link className="navbar-brand text-green fw-bolder mx-5" to="/">
            BIZBOUQUET
          </Link>
          <button
          ...
          <div className="collapse navbar-collapse" id="navbarScroll">
            <ul className="navbar-nav ms-auto me-5 my-2 my-lg-0 navbar-nav-scroll">
              <li className="nav-item">
                <Link className="nav-link active text-green fw-bold" aria-current="page" to="/">
                  Home
                </Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link text-green fw-bold" to="/about">
                  About us
                </Link>
              </li>
              <li className="nav-item">
